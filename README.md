...
> **R:**Porque el preprocesador expande los macros y directivas copiando los headers estandar completos del sistema.
...
> **R:**Porque el preprocessamiento remueve todos los comentarios del codigo fuente.
...
> **R:**Informan el origen de cada bloque. El bloque que contiene la declaración de printf proviene de c:\\mingw\\include\\stdio.h.
...
> **R:**Define a la funcion sumar y luego la llama.
...
> **R:**Tiene tipo T en matematica.o porque esta definida en ese archivo, mientras que en programa.o esta siendo llamada.
...
> **R:**Los sibolos que quedas indefinidos son funciones de la biblioteca dinamica del sistema. Las resuelve el cargador dinamico cuando se ejecuta el programa.
...
> **R:**La diferencia es que una macro se expande durante el preprocesamiento mientras que una funcion real se expande durante la compilacion. Las funciones reales tienen verificación de tipo.
...
> **R:**Las funciones son de tipo T y viven en la seccion text. Las variables globales con valor inicial son de tipo D y viven en la seccion data.
...
> **R:**        ntdll.dll => /c/WINDOWS/SYSTEM32/ntdll.dll (0x7fff81b00000)
        ntdll.dll => /c/Windows/SysWOW64/ntdll.dll (0x775d0000)
        wow64.dll => /c/WINDOWS/System32/wow64.dll (0x7fff7f8a0000)
        wow64base.dll => /c/WINDOWS/System32/wow64base.dll (0x7fff80a10000)
        wow64win.dll => /c/WINDOWS/System32/wow64win.dll (0x7fff80880000)
        wow64con.dll => /c/WINDOWS/System32/wow64con.dll (0x7fff7faa0000)

¿Por qué `libc` no hubo que especificarla explícitamente al enlazar con `gcc`?

> **R:**Porque es la biblioteca fundamental de C.
